...
public final class ModuloExpression extends ArithmeticExpression {
   ...
   */
  public ModuloExpression(long position, Expression leftOperand, Expression rightOperand) {
  ...
  protected Expression fold(Compiler compiler, FunctionSymbol currentFunction) {
    if (leftOperand instanceof ConstantNumberExpression &&
      ...
      return new ConstantNumberExpression(getPosition(),
          ((ConstantNumberExpression) leftOperand).value.remainder(
  ...
  public void generate(Method m) {
    super.generate(m);
    type.generateModulo(m);
  }

  @Override
  public String toString() {
    return leftOperand.toString() + " Mod " + rightOperand.toString();  // COV_NF_LINE
  }
}
