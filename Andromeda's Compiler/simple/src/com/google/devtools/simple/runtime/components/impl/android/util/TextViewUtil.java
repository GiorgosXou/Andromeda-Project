...
public class TextViewUtil {
  ...
  public static void setJustification(TextView textview, int justification) {
    ...
    switch (justification) {
      ...
      case Component.JUSTIFY_LEFT_TOP:
        gravity = (Gravity.LEFT|Gravity.TOP);
        break;

      case Component.JUSTIFY_LEFT_CENTER:
        gravity = (Gravity.LEFT|Gravity.CENTER_VERTICAL);
        break;

      case Component.JUSTIFY_LEFT_BOTTOM:
        gravity = (Gravity.LEFT|Gravity.BOTTOM);
        break;

      case Component.JUSTIFY_CENTER_TOP:
        gravity = (Gravity.CENTER_HORIZONTAL|Gravity.TOP);
        break;

      case Component.JUSTIFY_CENTER_CENTER:
        gravity = (Gravity.CENTER_HORIZONTAL|Gravity.CENTER_VERTICAL);
        break;

      case Component.JUSTIFY_CENTER_BOTTOM:
        gravity = (Gravity.CENTER_HORIZONTAL|Gravity.BOTTOM);
        break;

      case Component.JUSTIFY_RIGHT_TOP:
        gravity = (Gravity.RIGHT|Gravity.TOP);
        break;

      case Component.JUSTIFY_RIGHT_CENTER:
        gravity = (Gravity.RIGHT|Gravity.CENTER_VERTICAL);
        break;
		
      case Component.JUSTIFY_RIGHT_BOTTOM:
