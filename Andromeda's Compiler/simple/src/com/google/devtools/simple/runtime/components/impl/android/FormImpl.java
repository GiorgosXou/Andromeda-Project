...
public abstract class FormImpl extends PanelImpl implements Form {
  ...
  @Override
  public void Resumed() {
	EventDispatcher.dispatchEvent(this, "Resumed");
  }
  @Override
  public void Stopped() {
  ...
  public void FormLoad() {
	EventDispatcher.dispatchEvent(this, "FormLoad");
  }

  @Override
  public void FormHide() {
	EventDispatcher.dispatchEvent(this, "FormHide");
  }
 ...
 @Override
 public void VB4AInputBoxClicked(String inpVal){
	EventDispatcher.dispatchEvent(this, "VB4AInputBoxClicked",inpVal);
 }

 @Override
 public void VB4AMsgboxClicked(int button){
	EventDispatcher.dispatchEvent(this, "VB4AMsgboxClicked",button);
 }
 
 @Override
 public void VB4AListboxClicked(int id){
	EventDispatcher.dispatchEvent(this, "VB4AListboxClicked",id);
 }
 
  @Override
 public void VB4ARadioboxClicked(int id){
	EventDispatcher.dispatchEvent(this, "VB4ARadioboxClicked",id);
 }
  @Override
 public void VB4ACheckboxClicked(boolean[] val){
	EventDispatcher.dispatchEvent(this, "VB4ACheckboxClicked",val);
 }
  @Override
  public int Column() {
...
/*
  ...
  public void BackgroundColor(int color) {
	Activity context = ApplicationImpl.getContext();
    context.getWindow().setBackgroundColor(color);
  }
*/
  @Override
  public View getView() {
