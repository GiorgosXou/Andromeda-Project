...
public final class Conversions {
  ...
  @SimpleFunction
  public static byte[] CByte(String v) {
	return v.getBytes();
  }
  
  @SimpleFunction
  public static byte[] CByte2(String v, String codec) throws UnsupportedEncodingException{
	return v.getBytes(codec);
  }
  
  @SimpleFunction
  public static String CString(byte[] v) {
	String strRead = new String(v);
	strRead = String.copyValueOf(strRead.toCharArray(), 0, v.length); 
	return strRead; 
  }
  ...
  @SimpleFunction
  public static float Val(String v) {
