...
public interface Component {
  ...
  /*
  VB4A From AutoResize Values
  VB4A窗体缩放方式
  */
  
  @SimpleDataElement
  static final int KEEPRATIO = 0;
  @SimpleDataElement
  static final int FILLXY = 1;
  @SimpleDataElement
  static final int NOZOOM = 2;
  /*
   * Color constants.
   */
  @SimpleDataElement
  ...
  @SimpleDataElement
  static final int JUSTIFY_LEFT_TOP = 3;
  @SimpleDataElement
  static final int JUSTIFY_LEFT_CENTER = 4;
  @SimpleDataElement
  static final int JUSTIFY_LEFT_BOTTOM = 5;
  @SimpleDataElement
  static final int JUSTIFY_CENTER_TOP = 6;
  @SimpleDataElement
  static final int JUSTIFY_CENTER_CENTER = 7;
  @SimpleDataElement
  static final int JUSTIFY_CENTER_BOTTOM = 8;
  @SimpleDataElement
  static final int JUSTIFY_RIGHT_TOP = 9;
  @SimpleDataElement
  static final int JUSTIFY_RIGHT_CENTER = 10;
  @SimpleDataElement
  static final int JUSTIFY_RIGHT_BOTTOM = 11;
  ...
  @SimpleDataElement
  static final int LAYOUT_RELATIVE = 4;
  ...
  @SimpleDataElement
  static final String WhoIsMyDady = "LuChengwei_VB4A_yourdds520@163.com";
  /*
  ...
  //VB4ADialog buttons
  @SimpleDataElement
  static final int VB4AYes=0;
  @SimpleDataElement
  static final int VB4ANo=1;
  @SimpleDataElement
  static final int VB4ACancel=2;
  /*
