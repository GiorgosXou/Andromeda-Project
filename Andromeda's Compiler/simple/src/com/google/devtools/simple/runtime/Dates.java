...
public final class Dates {
  ...
  @SimpleFunction
  public static Calendar DateDiff(int intervalKind, Calendar date1, Calendar date2) {
  ...
  @SimpleFunction
  public static Calendar DateAdd(Calendar date, int intervalKind, int interval) {

	Calendar dataTmp;
	dataTmp=date;
	dataTmp.add(intervalKind, interval);
	return dataTmp;
