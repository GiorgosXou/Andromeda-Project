...
public interface Form extends VisibleComponent, ComponentContainer {
  ...
  @SimpleEvent
  void VB4AInputBoxClicked(String inpVal);

  @SimpleEvent
  void VB4AMsgboxClicked(int button);

  @SimpleEvent
  void VB4AListboxClicked(int id);
  
  @SimpleEvent
  void VB4ARadioboxClicked(int id);
  
  @SimpleEvent
  void VB4ACheckboxClicked(boolean[] val);
